...
curl -XPOST http://localhost:4000/configs/registerService -H "Content-Type: application/json" -d '{  "name": "ns_provisioner",  "host": "localhost",  "port": 4012,  "path": ""}' -H "X-Auth-Token: 504cec46-54e9-4ab1-8c72-aee9a72e5f36"
...
curl -XPOST http://localhost:4000/configs/registerService -H "Content-Type: application/json" -d '{  "name": "logstash",  "host": "localhost",  "port": 5228,  "path": ""}'
